...
return [
    ...
    'menu' => [
        'platform_suppliers' => 'Supplier directory',
    ...
    'platform_suppliers' => [
        ...
        'mailing_title' => 'Supplier mailings',
        'mailing_description' => 'Mailing center for the supplier directory.',
        'mailing' => [
            'results_title' => 'Mailing results',
            'create_btn' => 'Create mailing',
            'modal_title' => 'Create mailing',
            'col_name' => 'Name',
            'col_type' => 'Type',
            'col_progress' => 'Progress',
            'col_actions' => 'Actions',
            'empty' => 'No mailings found',
            'field_name' => 'Name',
            'field_emails_limit' => 'Number of emails to send',
            'field_template' => 'Template type',
            'field_tenders' => 'Tenders',
            'field_company_filter' => 'Company filter',
            'select_template' => 'Select template',
            'no_tenders' => 'No active tenders',
            'emails_limit_hint' => 'Maximum number of emails for this mailing',
            'tenders_hint' => 'Select tenders to include in the mailing. Links will replace {{TendersList}} in the template.',
            'company_filter_placeholder' => 'Keywords separated by comma',
            'company_filter_hint' => 'Filter by company name. Leave empty to send to all.',
            'total_suppliers_hint' => 'Total suppliers with email',
            'btn_create' => 'Create',
            'btn_start' => 'Start',
            'btn_stop' => 'Stop',
            'btn_delete' => 'Delete',
            'confirm_delete' => 'Are you sure you want to delete this mailing?',
            'status' => [
                'draft' => 'Draft',
                'running' => 'Running',
                'paused' => 'Paused',
            ...
            'created' => 'Mailing created successfully.',
            'started' => 'Mailing started.',
            'stopped' => 'Mailing paused.',
            'deleted' => 'Mailing deleted.',
            'cannot_start' => 'Cannot start mailing in current status.',
            'cannot_stop' => 'Cannot stop mailing in current status.',
            'no_recipients' => 'No available recipients for mailing.',
        ],
    ],
