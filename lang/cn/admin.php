...
return [
    ...
    'platform_suppliers' => [
        ...
        'import' => [
            'title' => '从 CSV 导入供应商',
            'field_file' => 'CSV 文件',
            'field_language' => '供应商语言',
            'submit' => '上传',
            'hint' => '文件需包含表头 Company Name, Primary Email, Primary Phone, Website 等字段。无法归类的字段将按行写入备注。',
            'validation' => [
                'file_required' => '请选择要上传的文件。',
            ],
            'invalid_file' => '无法读取 CSV 文件。',
            'cannot_read' => '无法打开 CSV 文件进行读取。',
            'empty_file' => 'CSV 文件为空或不包含数据。',
            'success' => '导入完成。新增记录：:created 条，跳过行数：:skipped 条。',
        ],
        'languages' => [
            'ru' => '俄语',
            'en' => '英语',
