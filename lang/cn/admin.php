...
return [
    ...
    'platform_suppliers' => [
        ...
        'mailing_title' => '供应商群发',
        'mailing_description' => '供应商目录的群发页面。',
        'mailing' => [
            'results_title' => '群发结果',
            'create_btn' => '创建群发',
            'modal_title' => '创建群发',
            ...
            'empty' => '暂无群发记录',
            'field_name' => '名称',
            'field_emails_limit' => '发送邮件数量',
            'field_template' => '模板类型',
            'field_tenders' => '招标',
            'field_company_filter' => '公司筛选',
            'select_template' => '选择模板',
            'no_tenders' => '暂无活跃招标',
            'emails_limit_hint' => '此群发的最大邮件数量',
            'tenders_hint' => '选择要包含在群发中的招标。链接将替换模板中的{{TendersList}}。',
            'company_filter_placeholder' => '关键词，用逗号分隔',
            'company_filter_hint' => '按公司名称筛选。留空则发送给所有人。',
            'total_suppliers_hint' => '有邮箱的供应商总数',
            'btn_create' => '创建',
            'btn_start' => '开始',
            'btn_stop' => '停止',
            'btn_delete' => '删除',
            'confirm_delete' => '您确定要删除此群发吗？',
            'status' => [
                'draft' => '草稿',
                'running' => '进行中',
                'paused' => '已暂停',
            ...
            'stopped' => '群发已暂停。',
            'deleted' => '群发已删除。',
            'cannot_start' => '当前状态无法启动群发。',
            'cannot_stop' => '当前状态无法停止群发。',
            'no_recipients' => '没有可用的群发收件人。',
        ],
    ],
