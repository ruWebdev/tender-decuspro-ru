...
- В качестве системы распределения ролей используется Spatie Laravel Permission. Если в коде есть другие реализации ролей и прав пользователей, то необходимо удалить их без дополнительных уточнений.
